...
## Icons (4×4 grid, left to right, top to bottom)

### Row 1: Directional Arrows (all same style)

**1.1 — Arrow Left**
A bold left-pointing arrow in railroad/signal style.

**1.2 — Arrow Right**
Matching right-pointing arrow, same weight and style.

**1.3 — Arrow Up**
Matching upward-pointing arrow.

**1.4 — Arrow Down**
Matching downward-pointing arrow.

### Row 2: Railroad Equipment
...
**2.4 — Coal**
A heap of coal or a coal cart/tender — fuel for the locomotives.
...
**3.3 — Money / Banknotes**
A stack of paper bills or coins — represents cash/treasury.

**3.4 — Telegraph Device**
A telegraph key/sounder — 1880s communication device used along railroad lines.

### Row 4: People & Status

**4.1 — Conductor**
A railroad conductor in uniform with peaked cap — front-facing or profile bust.

**4.2 — Locomotive (side view)**
A simple side-profile silhouette of a steam locomotive.
