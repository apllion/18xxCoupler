...
export const g1817 = {
  ...defaults,
  maturity: 2, testQuality: 1, titleId: 'g1817', roundTypes: ['SR', 'OR', 'MR'],
  unsoldShareDividends: 'ipo', // Treasury shares pay corp, market pays nothing
  ...
  specialties: 'Corp sizing 2/5/10 share • Seed money $200 • Train export • Selection auction',
  ...
  // Loan system
  loans: {
    type: '1817',         // Global escalating interest, liquidation on default
