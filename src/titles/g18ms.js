...
export const g18ms = {
  ...
  implemented: 'Shares • Dividends • Player loans (18MS) • Auto stock movement • Salvage trains • Multiplier D-trains',
  ...
  // Player loans: emergency train funding, 50% interest, auto-repay, compounds each SR
  loans: {
    type: '1880_player',      // Same system: player loans, not corp loans
    compoundRate: 50,          // 50% compound interest per SR
    autoRepay: true,           // Debts repaid automatically when player receives money
    debtBlocksSpending: true,  // Player in debt cannot spend money
  },
